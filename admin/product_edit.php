...
$product = selectData('products', $mysqli, "WHERE id=$id");
if ($product->num_rows > 0) {
    ...
    $expire_date    = $data['expire_date'] == "0000-00-00" ? '' : $data['expire_date'];
}
if (isset($_POST['form_sub']) && $_POST['form_sub'] == '1') {
    ...
    if (!$error) {
        ...
        $result = updateData('products', $mysqli, $data, $where);
        if ($result) {
            $url = $admin_base_url . 'product_list.php?success=Product Update Success';
            header("Location: $url");
            exit;
        } else {
            $error = true;
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-center">
            <div class="col-md-6 col-sm-10 col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="<?= $admin_base_url . "product_edit.php?id=" . $id ?>" method="POST">
