...
if (isset($_GET['id']) && $_GET['id'] !== '') {
    $id = $_GET['id'];
    $select_res = selectData('discounts', $mysqli, "WHERE id='$id'");
    if ($select_res->num_rows > 0) {
        ...
        $url = $admin_base_url . "discount_list.php?error=Id Not Found";
        header("Location: $url");
    }
} else {
    $url = $admin_base_url . "discount_list.php?error=Id Not Found";
...
if (isset($_POST['form_sub']) && $_POST['form_sub'] == '1') {
    ...
    if (!$error) {
        ...
        $result = updateData('discounts', $mysqli, $data, $where);
        if ($result) {
            $url = $admin_base_url . 'discount_list.php?success=Discount Update Success';
            header("Location: $url");
            exit;
        } else {
            $error = true;
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-center">
            <div class="col-md-6 col-sm-10 col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="<?= $admin_base_url . "discount_edit.php?id=" . $id ?>" method="POST">
