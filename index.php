...
$trending_product_sql = "SELECT 
                    ...
                    LEFT JOIN product_img ON product_img.product_id = products.id
                    -- WHERE  products.discount_id > 0
                    GROUP BY products.id
                    ORDER BY products.sale_price ASC
                    LIMIT 10";
                                                ...
                                                <div class="product-item">
                                                    ...
                                                    <figure>
                                                        <a href="index.html" title="Product Title">
                                                            <img src="<?= $admin_base_url . "upload/" . $row['image'] ?>" class="tab-image">
                                                        </a>
                                                    </figure>
                                                    <h3><?= $row['name'] ?></h3>
                                                    <p class=" m-0 text-lowercase"><?= $row['stock_count'] ?>pcs</p>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between product_item">
                                                        <div class="input-group product-qty">
                                                            ...
                                                            <input type="number" id="quantity" name="quantity" max="<?= $row['stock_count'] ?>" readonly class="form-control input-number" value="1">
                                                            <span class="input-group-btn">
                                                                <button type="button" class="quantity-right-plus btn btn-success btn-number" data-type="plus" data-max="<?= $row['stock_count'] ?>">
                                                                    <svg width="16" height="16">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 copyright">
                    <p>© 2025 POS. All rights reserved.</p>
                </div>
                <div class="col-md-6 credit-link text-start text-md-end">
                    <p>Free HTML Template by POS Distributed by Softguide</a></p>
                </div>
            </div>
        </div>
    </div>
